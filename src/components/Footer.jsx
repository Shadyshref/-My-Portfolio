...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#0f112f] text-white px-4 py-8 w-full">
      <div className="w-full max-w-[1300px] mx-auto flex flex-col gap-8 md:flex-row md:gap-4 md:justify-between md:items-center">
        ...
        <ul className="flex flex-wrap justify-center gap-4 md:gap-6 md:flex-1 md:justify-center">
          {links.map((link, i) => (
            <li
              ...
              className="cursor-pointer hover:text-[#4CB7F5] transition-colors"
            >
              {link.name}
            </li>
          ))}
        ...
        <div className="flex flex-col items-center gap-4 sm:flex-row sm:gap-6 md:flex-1 md:justify-end">
          ...
          <a
            ...
            className="flex items-center gap-2 hover:text-[#4CB7F5] transition text-center"
          >
