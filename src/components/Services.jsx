...
const Services = () => {
    ...
    },
    {
      ...
      description: (
        <>
          ...
          <br />
          Experience with PostgreSQL, MongoDB, Firebase.
          <br />
  ...
  return (
    <section id="services" className="text-white mt-80 px-4 scroll-mt-[80px]">
         <motion.div 
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
        {services.map((service, index) => (
            <div
            key={index}
            className="bg-[#0f112f] p-5 rounded-xl shadow-lg hover:shadow-[#4CB7F5]/50 transition-shadow flex flex-col items-start gap-4"
            >
